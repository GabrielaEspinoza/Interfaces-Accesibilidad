window.onload = () => {
  ...
  document.querySelectorAll(".project").forEach(element => { element.addEventListener("click", e => openModal(e));
  });
...
/**funcion que establece a la tecla Esc como alternativa de salir de las imagenes de los proyectos */
...
/**Funcipon que muestra mensaje de error si la casilla nombre no ha sido llenada */
function validateForm(e) {
  e.preventDefault();
  const nameField = document.getElementById("name");
  if (nameField.value === "")
  {
    document.getElementById("name-error").innerHTML = "Es necesario poner un nombre para enviar el formulario";
  } else {
  showNotification();
  }
}
